...
from src.utils import get_sentinel_to_id_mapping, merge_span_masking
...
class GenerationSampler(nn.Module):
    ...
    def generate_sam_dense(
        ...
        for i in range(batch_size):
            ...
            merged_seq.extend(
                merge_span_masking(input_seq, target_seq, sentinel_ids=sentinel_ids)
            )
        ...
        mod_dict[key] = {
            ...
            "input_mask": torch.zeros(
                merged_seq.shape, dtype=torch.bool, device=device
            ),
