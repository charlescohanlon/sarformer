...
#SBATCH --job-name=rgb_pretokenization
#SBATCH --time=24:00:00      # hh:mm:ss for the job
#SBATCH --constraint=scratch
#SBATCH -e /u/cohanlon/sarformer/slurm_outputs/pretokenization/rgb/slurm-%j.err
#SBATCH -o /u/cohanlon/sarformer/slurm_outputs/pretokenization/rgb/slurm-%j.out
### GPU options ###
