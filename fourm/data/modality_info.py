...
MODALITY_INFO = {
    ...
    "t5_caption": {
        "encoder_embedding": partial(
            SequenceEmbEncoderEmbedding, max_length=77, padding_idx=0
        ),
        "decoder_embedding": None,
        "min_tokens": 0,
        "max_tokens": 77,
    ...
    "tok_dinov2_global": {
        ...
        "patch_size": 56,
        "encoder_embedding": partial(
            ImageTokenEncoderEmbedding, vocab_size=8192, sincos_pos_emb=False
        ),
        "decoder_embedding": partial(
            ImageTokenDecoderEmbedding, vocab_size=8192, sincos_pos_emb=False
        ),
        "min_tokens": 0,
        "max_tokens": 16,
        "type": "img",
