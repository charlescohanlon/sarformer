...
# Model definitions
__all__ = ["fm_base_12e_convnext_base_swiglu_qknorm_nobias"]
...
class SARFormer(nn.Module):
    ...
    def forward_mask_encoder(
        ...
        # we shuffle the encoder tokens instead of quasi-shuffling them
        ...
        # we don't remove any tokens from encoder
        ids_keep = ids_shuffle  # [:, :num_encoder_tokens]

        # collect the selected tokens in the order of ids_keep and faster than tensor indexing
        ...
        encoder_mask = encoder_mask_all  # should be all 0s so shuffling is irrelevant
...
@register_model
def fm_base_12e_convnext_base_swiglu_qknorm_nobias(
    encoder_embeddings: Dict[str, nn.Module],
    **kwargs,
):
    pass
