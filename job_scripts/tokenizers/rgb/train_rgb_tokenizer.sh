...
#SBATCH --job-name=rgb_tokenizer
#SBATCH --time=24:00:00      # hh:mm:ss for the job
#SBATCH --constraint=scratch
#SBATCH -e /u/cohanlon/sarformer/slurm_outputs/tokenizers/rgb/slurm-%j.err
#SBATCH -o /u/cohanlon/sarformer/slurm_outputs/tokenizers/rgb/slurm-%j.out
### GPU options ###
...
OMP_NUM_THREADS=128 torchrun --nproc_per_node=8 run_training_vqvae.py \
    --config cfgs/sarformer/tokenizers/rgb/ViTB-ViTB_16k_224.yaml
